...
Адаптивный лендинг, созданный с использованием **HTML**, **SCSS**. Проект демонстрирует современную структуру верстки, семантическую разметку и организацию стилей с препроцессором SCSS.
